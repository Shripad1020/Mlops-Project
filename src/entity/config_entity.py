...
class DataIngestionConfig:
    ...
    featutre_store_file_path = os.path.join(data_ingestion_dir,DATA_INGESTION_FEATURE_STORE_DIR,FILE_NAME)
...
class DataValidationConfig: 
    data_validation_dir:str = os.path.join(training_pipeline_config.artifact_dir,DATA_TRANSFORMATION_DIR_NAME)
...
class ModelEvaluationConfig:
    ...
    storage_name:str = MODEL_BUCKET_NAME
    gcs_model_key_path:str = MODEL_FILE_NAME
